...
public class AppAyuda extends Application 
{
    ...
    {
        // create scene
        stage.setTitle("Web View - AppAyuda");
...
class Browser extends Region 
{
   ...
   final private static String[] imageFiles = new String[]
   {
    ...
    {
        "https://www.zelda.com/breath-of-the-wild/es/",
        "https://www.nintendo.es/Juegos/Portal-de-Nintendo/Portal-para-Super-Mario/Portal-para-Super-Mario-627604.html",
    ...
    final Button toggleHelpTopics = new Button("Mostrar topics");
    ...
    {       
        ...
        // load the home page        
        webEngine.load("https://moodle.org/?lang=es");
